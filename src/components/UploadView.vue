  ...
  methods: {
    upload($event) {
      ...
      files.forEach((file) => {
        ...
        const storageRef = storage.ref(); //vue-music-app-38d35.appspot.com
        const songsRef = storageRef.child(
          `songs/${auth.currentUser.uid}-${randomNumber}-${file.name}`
        ); //vue-music-app-38d35.appspot.com/songs/filename.mp3
